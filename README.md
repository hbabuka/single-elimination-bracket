...
<details>
    <summary><em style="color: darkgrey;">Note: if you don't have a Figma account, don't forget to use the menu in the top left corner to navigate to different pages of the file*</em></summary>
